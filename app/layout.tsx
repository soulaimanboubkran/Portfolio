...
>
 ...
 <div className="bg-[#f5f6d2] absolute z-[-10] dark:z-[-10] top-[-9rem] md:right-[1rem] right-[0rem] h-[99.25rem] w-[31.25rem] rounded-full blur-[3rem] sm:w-[68.75rem] dark:bg-[#2d796a]"></div>
  ...
  <div className="bg-[#195190FF] absolute z-[-10] dark:z-[-10] bottom-[-6rem] md:right-[1rem] right-[1rem] h-[44.25rem] w-[31.25rem] rounded-full blur-[3rem] sm:w-[68.75rem] dark:bg-[#958fd6]"></div>
  <div className="bg-[#ABD1C9FF] absolute z-[-10] dark:z-[-10] bottom-[14rem] left-[-35rem] h-[33.25rem] w-[50rem] rounded-full blur-[3rem] sm:w-[68.75rem] md:left-[-11rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#958fd6]"></div>
