...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <div className="bg-[#03215d] absolute top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] dark:bg-[#7e393a]"></div>
        ...
        <Header/>
        {children}</ActiveSectionContextProvider></ThemeContextProvider></body>
    </html>
  )
}
