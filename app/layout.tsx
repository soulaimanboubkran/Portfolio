...
export default function RootLayout({
 ...
 <div className="bg-[#f5f6d2] absolute z-[-10] dark:z-[-10] top-[-9rem] md:right-[1rem] right-[0rem] h-[99.25rem] w-[31.25rem] rounded-full blur-[3rem] sm:w-[68.75rem] dark:bg-[#2d796a]"></div>
  ...
  <div className="bg-[#f3faf0] absolute z-[-10] dark:z-[-10] bottom-[-6rem] md:right-[1rem] right-[1rem] h-[44.25rem] w-[31.25rem] rounded-full blur-[3rem] sm:w-[68.75rem]  dark:bg-[#0e1d29]"></div>
